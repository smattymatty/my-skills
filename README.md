...
Skills for my strict AI workflow. I value authorship, control, and understanding.

Every skill you add to your AI assistant is a small transfer of judgment - somebody decided how a piece of thinking should go and wrote it down so your assistant runs it instead of improvising. The good news is the lock on that door is barely a lock: a skill is just markdown, and the thinking inside it is just words. So the only thing I ask of these is that you read them before you run them. They're shaped for my brain and my workflow. The useful move isn't to install them, it's to read them, disagree, and build the version that fits you.
